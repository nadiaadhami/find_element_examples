...
// https://stackoverflow.com/questions/11505137/java-program-to-find-all-dictionary-words-from-a-given-string
// find all dictionary words in a given string

public final class FindAllDictWordsInAString {
    ...
    private static char getRandomVowel(){
        ...
        return Vowel.charAt(randomInt);  //GOOD
    }
